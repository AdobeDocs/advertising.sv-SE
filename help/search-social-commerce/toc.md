...
+ Vanliga uppgifter {#common-tasks}
   ...
   + Anpassa datavyer {#data-views}
      ...
      + Ad hoc-visningsinställningar {#ad-hoc-settings}
         ...
         + [Redigera och sortera kolumnuppsättningen från [!UICONTROL Custom Columns] icon](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-sort-icon.md)
   ...
   + Klickspårning {#click-tracking}
      ...
      + Komponenter i klickspårnings-URL:er {#click-tracking-components}
         + Standardformat för klickspårnings-URL:er {#click-tracking-formats}
            ...
            + [Klickningsspårningsformat för [!DNL Baidu]](/help/search-social-commerce/tracking/formats-click-tracking-baidu.md)
            + [Klickningsspårningsformat för [!DNL Google Ads]](/help/search-social-commerce/tracking/formats-click-tracking-google.md)
            + [Klickningsspårningsformat för [!DNL Microsoft Advertising]](/help/search-social-commerce/tracking/formats-click-tracking-microsoft.md)
            + [Klickningsspårningsformat för [!DNL Naver]](/help/search-social-commerce/tracking/formats-click-tracking-naver.md)
            + [Klickningsspårningsformat för [!DNL Yahoo! Display Network]](/help/search-social-commerce/tracking/formats-click-tracking-yahoo-display-network.md)
...
+ Kampanjhantering {#campaign-management}
   ...
   + Konfigurera konton {#campaign-management-accounts}
      + Annonsnätverkskonton {#ad-network-accounts}
         ...
         + [Uppdatera spårningskoden för AMO ID för en [!DNL Google Ads] konto](/help/search-social-commerce/campaign-management/accounts/update-amo-id-google.md)
   ...
   + Hantera kampanjer {#management}
      ...
      + Hantera data i [!UICONTROL Campaigns] > [!UICONTROL Campaigns] vyer {#campaigns}
         ...
         + Nyckelord {#keywords}
            ...
            + Nyckelordsinställningar per annonsnätverk {#keyword-settings-by-network}
               + [[!DNL Baidu] nyckelordsinställningar](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-baidu.md)
               + [[!DNL Google Ads] nyckelordsinställningar](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-google.md)
               + [[!DNL Microsoft Advertising] nyckelordsinställningar](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-microsoft.md)
               + [[!DNL Yahoo! Japan Ads] nyckelordsinställningar](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yahoo-japan.md)
               + [[!DNL Yandex] nyckelordsinställningar](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yandex.md)
         + Annonser {#ads}
            ...
            + Annonsinställningar per annonsnätverk {#ad-settings-by-network}
               ...
               + [[!DNL Google Ads] annonsinställningar som bara kan anropas](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-call.md)
               + [[!DNL Google Ads] expanderade dynamiska sökannonsinställningar](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-dsa.md)
               + [[!DNL Google Ads] inställningar för responsiv sökning och](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-rsa.md)
               + [[!DNL Microsoft Advertising] expanderade dynamiska sökannonsinställningar](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-dsa.md)
               + [[!DNL Microsoft Advertising] multimediaannonsinställningar](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-multimedia.md)
               ...
               + [[!DNL Microsoft Advertising] inställningar för responsiv (målgrupp) annonsering](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-responsive.md)
               + [[!DNL Microsoft Advertising] inställningar för responsiv sökning och](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-rsa.md)
         ...
         + Målgrupper och målgrupper {#audiences-and-targets}
            + Målgrupper {#audiences}
               ...
               + [Skapa [!DNL Google Ads] kundmatcha målgrupper från [!DNL Adobe] målgrupper](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-adobe-audience.md)
      ...
      + Automatisera kampanjdata med hjälp av lagerflöden {#inventory-feeds}
         ...
         + Mallar {#feed-templates}
            ...
            + [[!DNL Google Ads] inställningar för butiks- och mallinställningar](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-google-shopping.md)
            + [[!DNL Microsoft Advertising] inställningar för butiks- och mallinställningar](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-microsoft-shopping.md)
      ...
      + Implementera kampanjer och annonser med unika arbetsflöden{#special-campaign-types}
         ...
         + [Implementera [!DNL Google Ads] max-kampanjer för prestanda](/help/search-social-commerce/campaign-management/special-campaign-types/google-performance-max-campaigns.md)
...
+ verktyg {#tools}
   ...
   + Överför mätvärden för [!DNL Naver] konton med enbart spårning {#generic-tracking}
...
+ Administration {#admin}
   ...
   + Konfigurera datakällor {#data-sources}
      + [Synkronisering [!DNL Google Analytics] konverteringsmått](/help/search-social-commerce/admin/data-sources/data-source-about.md)
      ...
      + [Konfigurera en [!DNL Google Analytics] visa som en datakälla](/help/search-social-commerce/admin/data-sources/data-source-configure.md)
