...
+ Vanliga uppgifter {#common-tasks}
   ...
   + Anpassa datavyer {#data-views}
      ...
      + Ad hoc-visningsinställningar {#ad-hoc-settings}
         ...
         + [Sortera om en kolumn](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-sort.md)
...
+ (Beta) NYTT ANVÄNDARGRÄNSSNITT {#new-ui}
   ...
   + Plan {#plan}
      + Mål {#objectives}
         + [Om mål](/help/search-social-commerce/new-ui/goals/objectives/objective-about.md)
         + [Skapa ett mål](/help/search-social-commerce/new-ui/goals/objectives/objective-create.md)
         + [Redigera ett mål](/help/search-social-commerce/new-ui/goals/objectives/objective-edit.md)
         + [Ta bort ett mål](/help/search-social-commerce/new-ui/goals/objectives/objective-delete.md)
         + [Använd viktrekommendationer på ett mål](/help/search-social-commerce/new-ui/goals/objectives/objective-apply-weight-recommendations.md)
         + [Hämta resultatvärden för mål](/help/search-social-commerce/new-ui/goals/objectives/objective-download-performance-data.md)
         + [Målinställningar](/help/search-social-commerce/new-ui/goals/objectives/objective-settings.md)
   ...
   + Hantera {#manage}
      + Portföljer {#portfolios}
         ...
         + [Skapa en portfölj](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-create.md)
         ...
         + [Visa ett prestandagram i vyn [!UICONTROL Portfolios]](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-view-performance-graph.md)
      ...
      + Annonser {#ads}
         + [Om vyn [!UICONTROL Ads]](/help/search-social-commerce/new-ui/manage/ads/ad-view-about.md)
   ...
   + Rapporter {#reports}
      + Etikettklassificeringar {#label-classifications}
         + [Om etikettklassificeringar](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-about)
         + [Skapa en etikettklassificering](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-create)
         + [Tilldela klassificeringsvärden till kontokomponenter från kampanjhanteringsvyer](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-assign-campaign-management)
         + [Tilldela klassificeringsvärden till kontokomponenter med hjälp av kalkylblad](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-assign-bulksheets)
         + [Ta bort etikettklassificeringsvärden från kontokomponenter](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-remove)
         + [Ta bort etikettklassificeringsvärden](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-delete)
         + [Ta bort etikettklassificeringar](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-delete)
   + Mål {#target}
      + Nyckelord {#keywords}
         + [Om vyn [!UICONTROL Keywords]](/help/search-social-commerce/new-ui/target/keywords/keyword-view-about.md)
      ...
      + Placeringar {#placements}
         + [Om vyn [!UICONTROL Placements]](/help/search-social-commerce/new-ui/target/placements/placement-view-about.md)
         + [Hantera begränsningstilldelningar för placeringar](/help/search-social-commerce/new-ui/target/placements/placement-assignments-manage.md)
   + Inställningar {#setup}
      + Konton {#accounts}
         + [Om och nätverkskonton](/help/search-social-commerce/new-ui/set-up/accounts/ad-network-account-about.md)
         + API-anslutningskonton {#api}
            + [Hantera annonsnätverkskonton via API-anslutning](/help/search-social-commerce/new-ui/set-up/accounts/api-accounts/api-account-manage.md)
            + [Synkronisera annonsdata manuellt via API-anslutning](/help/search-social-commerce/new-ui/set-up/accounts/api-accounts/sync-api-accounts.md)
         + Konton för dataöverföring {#data-upload}
         ...
         + [Hantera [!DNL Naver] konton endast för spårning](/help/search-social-commerce/new-ui/set-up/accounts/template-account-manage.md)
...
+ Spåra {#tracking}
   ...
   + Konverteringsspårning {#conversion-tracking}
      ...
      + Konverteringsspårning för Adobe Advertising {#advertising-conversion-tracking}
         ...
         + [Generera och implementera en konverteringstagg för Adobe Advertising](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/tools/tracking/conversion-tag-generate)
      ...
      + Hantera data i [!UICONTROL Campaigns] > [!UICONTROL Campaigns]-vyer {#campaigns}
         ...
         + Kampanjer {#campaigns}
            ...
            + Kampanjinställningar per annonsnätverk {#campaign-settings-by-network}
               + [Inställningar för [!DNL Baidu]-kampanj](/help/search-social-commerce/campaign-management/campaigns/campaign-settings-baidu.md)
         ...
         + Annonser {#ads}
            ...
            + Annonsinställningar per annonsnätverk {#ad-settings-by-network}
               ...
               + [[!DNL Microsoft Advertising] inställningar för responsiv sökannonsering](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-rsa.md)
