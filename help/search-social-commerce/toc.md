...
+ (Beta) NYTT ANVÄNDARGRÄNSSNITT {#new-ui}
   ...
   + Hantera {#manage}
      ...
      + Kampanjer {#campaigns}
         ...
         + [Visa ett prestandagram i vyn [!UICONTROL Campaigns]](/help/search-social-commerce/new-ui/manage/campaigns/campaign-view-performance-graph.md)
      ...
      + Annonsgrupper {#ad-groups}
         ...
         + [Visa ett prestandagram i vyn [!UICONTROL Ad Groups]](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-view-performance-graph.md)
