...
|  | [!UICONTROL Trigger this Alert] [when] | Hur ofta varningen söker efter angivna villkorsfilter och skickar e-postmeddelanden när alla villkor är uppfyllda:<ul><li><p>[!UICONTROL Daily at <*N*> `[AM\|PM]`]</p></li><li><p>[!UICONTROL Weekly on <*Veckodag*> vid &lt;*NN*> `[AM\|PM]`]</p></li><li><p>[!UICONTROL Every month on <*Dag N*> vid &lt;*NN*> `[AM\|PM]`]</p></li></ul>**Obs!** Detta värde påverkar inte utvärderingsperioden. |
