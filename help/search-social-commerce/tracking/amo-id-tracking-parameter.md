...
description: Läs mer om spårningsparametern som används för att dela Adobe Advertising-data med Adobe Analytics.
...
Adobe Advertising delar data om era kampanjer med Adobe Analytics med hjälp av parametern AMO ID append, som också kallas parametern `s_kwcid`, som består av annonskanaler och annonser för nätverksspecifika element.
