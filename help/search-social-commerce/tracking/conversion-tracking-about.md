...
* **Konverteringar som spåras i annonser:** (Endast för kunder med sökningar, sociala medier och Commerce) Annonsören tillhandahåller Search, Social och Commerce en feed-fil med valfri kombination av konverteringsdata online och offline. Se &quot;[Konverteringsspårning med en EF ID-feed](feed-efid.md)och &quot;[Konverteringsspårning med en transaktions-ID-feed](feed-transaction-id.md).&quot;
