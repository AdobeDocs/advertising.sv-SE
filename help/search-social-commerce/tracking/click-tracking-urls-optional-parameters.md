...
* Du kan lägga till nätverks- och annonsparametrar för Adobe i bas-URL:erna för kontot/kampanjen för att spåra fler data:
   ...
   * De nätverksspecifika parametrarna är dynamiska och sökmotorn infogar ett datavärde när användaren klickar på en annons. När du t.ex. lägger till `{param1}` annonsnätverket ersätter den med det faktiska {param1} -värdet när en slutanvändare klickar på annonsen.
...
Se [https://help.marketing.yahoo.co.jp/en/?p=115](https://help.marketing.yahoo.co.jp/en/?p=115).
