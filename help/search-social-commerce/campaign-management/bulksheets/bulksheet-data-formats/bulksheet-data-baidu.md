...
| [!UICONTROL EF Error Message] | n/a | n/a | n/a | n/a | n/a | (Ingår i genererade kalkylblad i informationssyfte) Platshållare för att visa felmeddelanden från Search, Social och Commerce gällande data på raden. Felmeddelanden finns i [!UICONTROL EF Errors] filer. Det här värdet är inte registrerat i annonsnätverket. |
