...
| [!UICONTROL Location] | n/a | n/a | n/a | n/a | Obligatoriskt | En geografisk plats där annonser för kampanjen ska placeras. Om du vill exkludera en plats anger du ett minustecken (`-`) för platsen. Om du inte anger specifika värden för kampanjen anges alla platser som mål. |
...
| [!UICONTROL Campaign Status] | Valfritt: Skapa eller redigera<br>krävs: Ta bort | n/a | n/a | n/a | n/a | Visningsstatus för kampanjen: <i>[!UICONTROL Active]</i>, <i>[!UICONTROL Paused]</i> eller <i>[!UICONTROL Deleted]</i> (endast befintliga kampanjer). Standardvärdet för nya kampanjer är <i>[!UICONTROL Active]</i>. Om du vill ta bort en aktiv eller pausad kampanj anger du värdet [!UICONTROL Deleted]. |
