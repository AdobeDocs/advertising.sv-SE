...
**[!UICONTROL Google Recommended Budget]:** (Valfritt; gäller för prestandamängder och sökkampanjer med alla nödvändiga inställningar och som endast omfattar annonsgrupper) Klicka **[!UICONTROL Show Recommendation]** om du vill visa den budget som [!DNL Google Ads] rekommenderar. För närvarande är endast kampanjer med färre än 40 000 nyckelord berättigade.
