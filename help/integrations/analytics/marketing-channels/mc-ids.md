...
Om du vill skapa en visningskanal skapar du en regel där EF-ID:t slutar med :i. Eftersom besökaren inte klickade på annonsen inkluderas inte `ef_id` eller `s_kwcid` i URL:en, så regeln kräver bara ett villkor.
