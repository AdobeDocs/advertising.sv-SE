---
title: Krav och viktig information för implementering av  [!DNL Analytics for Advertising]
description: Krav och viktig information för implementering av  [!DNL Analytics for Advertising]
...
Läs följande information innan du integrerar Adobe Advertising med Adobe Analytics.

## Krav för att rapportera Adobe Advertising-data i [!DNL Analytics]

* Något av följande:
   * Adobe Experience Platform Web SDK: `alloy.js`
   * Experience Cloud Identity Service: `visitorAPI.js` version 2.0 eller senare
...
## Krav för att dela analyssegment med Adobe Advertising

* Experience Cloud identitetstjänst: `visitorAPI.js` version 2.1 eller senare
...
Ge Adobe Advertising implementeringsteam följande information:
...
* Företagets Experience Cloud Organization ID (Org ID).
...
Eftersom [!DNL Analytics]-data skickas till Adobe Advertising för rapportering och optimering omfattas data av de attribueringsregler, inklusive visningsfönster och klickningsfönster, som är konfigurerade för annonsören i Adobe Advertising.

![inställningar för visningsfönster på annonsnivå i Adobe Advertising](/help/integrations/assets/a4adc-lookbacks.png)

* Adobe Advertising attribueringsklickningsfönster: Det antal dagar efter det första klicket där klickningen kan kopplas till en konvertering. Som standard är det här värdet 60 dagar. Det högsta värdet är 90 dagar.
* Adobe Advertising-attribueringsvisningsfönster: Det antal dagar efter ett annonsintryck som kan tilldelas en konvertering. Som standard är det här värdet 14 dagar. Det högsta värdet är 30 dagar
...
[!DNL Analytics] ställer in Adobe Advertising ID:n (AMO ID:n) i Analytics-träffen, enligt annonsörens [!DNL eVar]-beständighetsinställning, som gäller både klickningar och genomvisningar. Den beständiga inställningen är konfigurerad på Adobe Advertising baksida och din Adobe-kontogrupp kan ändra den.
...
Kontakta Adobe Account Team för att få de senaste annonsmiljöerna som stöds i varje kanal.

## Saker att känna till innan ni implementerar

* Adobe Advertising implementeringsteam skapar integreringen.

* Inga extra kostnader debiteras för den här integreringen och serveranrop leder inte heller till ytterligare [!DNL Analytics]- eller Adobe Advertising-avgifter.
...
* Integreringen skickar bara [!DNL Analytics] standard- och anpassade händelser till Adobe Advertising för att optimera köp av betalmedia och annonsinsatser. Det skickar inte [!DNL Analytics] segment, beräknade värden och [!DNL eVars] till Adobe Advertising för anbudsoptimering.
...
När Experience Cloud identitetstjänst har implementerats för en webbplats innehåller träffar som innehåller data från [!DNL Analytics] eller Adobe Advertising ett extra ID.
...
>* [JavaScript-kod för analyser för Advertising](/help/integrations/analytics/javascript.md)
