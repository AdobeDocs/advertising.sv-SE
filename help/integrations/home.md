...
| ---- | ------- | ----------- | -------------------- |
| Utgiven 29 oktober 2024 | [!DNL Adobe Analytics for Advertising] | (Annonsörer med [!DNL Adobe Analytics for Advertising] och [!DNL Microsoft Advertising] maximala prestandakampanjer) Data på resursgruppsnivå för era maximala prestandakampanjer är nu tillgängliga i Adobe Analytics när du implementerar en ny AMO ID-parameter ([!DNL s_kwcid]) i spårnings-URL:erna för era maximala prestandakampanjer, som inte innehåller annonser och nyckelord. Spårning för de flesta maximala prestandakampanjer har redan migrerats till det nya formatet. För prestandamängdskampanjer utan spårningsalternativet [!UICONTROL Auto Upload] som inte redan har migrerats till det nya formatet måste du uppdatera varje landningssidessuffix manuellt så att det innehåller följande AMO-ID-format:<br><br>`AL!%(userid)d!%(sid)d!%(creativeref)s!!!%(termid/orderid)d!!!%(campaignid)!%(adref)`<br><br>Adobe Analytics-data för maximala prestandakampanjer finns även i Sök, Socialt och Commerce. | Se det nya [AMO ID-formatet]((/help/integrations/analytics/ids.md#amo-id-format-search) och [när och hur du lägger till parametern i spårnings-URL:erna](/help/integrations/analytics/ids.md#amo-id-implement). |
