...
description: Läs om kontofinansiering för DSP.
...
# Advertising DSP kontofinansiering
...
* Adobe erbjuder en bedömd kreditlimit.

Alla kunder utvärderas och tilldelas kredit vid kontraktskörning av Adobe Credit Team. DSP brukar finansiera klientkonton med den tilldelade kreditnivån om inte förskottsbetalning har levererats. Konton finansieras inom 24 timmar efter att kontot har skapats.

När kunderna spenderar pengar på sina krediter eller förbetalningar minskar medel för medier och tjänster efter utgifter tills en nollbalans nås. Krediten justeras när fakturor betalas. Alla utestående Adobe-fakturor kan påverka er finansiering från DSP. Du ansvarar för att alla Adobe-fakturor betalas i tid. Om du behöver mer pengar än vad du kan använda kan du samarbeta med ditt Adobe-kontoteam.
...
Adobe förbehåller sig rätten att blockera ditt konto från att spendera på DSP av orsaker som innebär överträdelse av DSP [annonskrav &#x200B;](/help/policies/ad-requirements-policy.md) eller sekretessvillkor. Om Adobe blockerar ditt konto innehåller dina kontoinställningar ett spärrat meddelande. Samarbeta med ditt Adobe-kontoteam för att ta reda på orsaken till blocket och hur du kan korrigera felet.
