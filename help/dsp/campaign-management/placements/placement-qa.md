...
Om du vill uppdatera flera inställningar samtidigt kan du göra ändringar i markerade fält, spara filen och överföra den redigerade kalkylbladsfilen tillbaka till DSP. Redigerbara fält innehåller de mest redigerbara inställningarna.
...
1. Gör något av följande:
   ...
   * Klicka på **[!UICONTROL Placements]** på undermenyn och markera kryssrutan för en placering. Klicka på **[!UICONTROL ...]** > **[!UICONTROL Upload Bulksheet]** i verktygsfältet för gruppåtgärder.
