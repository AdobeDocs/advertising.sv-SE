---
title: Sök efter produktdokumentation med hjälp av AI-assisterad chatt
description: Lär dig hur du söker i Adobe Advertising DSP och [!DNL Creative] dokumentation med hjälp av en AI-assisterad chatt. Få svar med citat och förslag på uppföljningsfrågor.
...
# Sök efter produktdokumentation med hjälp av ett AI-assisterat chattgränssnitt

*Beta-funktion*

*Stöd endast för engelska*
...
>[!IMPORTANT]
>
>AI-genererade svar kan vara felaktiga eller vilseledande. Verifiera alltid svar och källor innan du använder dem för beslut som påverkar kostnader eller arbete.
...
* Hur skapar jag en annonstagg för en [!DNL Creative]-upplevelse?

## Skicka en fråga

Du kan ställa flera frågor i ett meddelande, men bara ett meddelande i taget. Vänta på ett svar innan du skickar ett annat.
...
## Ge feedback om ett svar

<!-- Not actionable in terms of improving page content -->

* Bredvid listan [!UICONTROL Documentation Sources]:

   * Om du vill ha praktiska svar klickar du på ![Tummen uppåt](/help/dsp/assets/thumbs-up.png "Tummen uppåt").

   * Klicka på ![Tummen nedåt](/help/dsp/assets/thumbs-down.png "Tummen nedåt") om du vill ha svar som inte är till någon hjälp.
