---
title: Visa information om en återanvändbar målgrupp
...
# Visa information om en återanvändbar målgrupp
...
1. (Valfritt) Om du vill visa antalet aktiva målgruppsmedlemmar per enhetstyp (för cookie-baserade ID:n) och per universell ID-typ klickar du på ![Enhetsfördelning](/help/dsp/assets/device-breakdown.png) bredvid målgruppens storlek.
