---
title: Hämta rapporter om avanmälan till konsumenter
...
# Hämta rapporter om avanmälan till konsumenter
...
>[!NOTE]
>
>Du kan även hämta rapporter om kunders avanmälan från försäljning med DSP [!DNL Trafficking API]. Instruktioner finns i dokumentationen för [!DNL Trafficking API]. Om din organisation inte använder [!DNL Trafficking API] men är intresserad av mer information kan du kontakta ditt Adobe-kontoteam.
