...
* Samla in egna data från förstahandsmålgrupper genom att skapa och implementera DSP-segment. Du kan senare rikta om användare i segmentet med annonser eller hindra användare i segmentet från att ta emot annonser. Du kan skapa följande typer av segment:
...
* DSP kan importera dina andra datasegment direkt från din datahanteringsplattform (DMP) och tillhandahålla dem till valfri uppsättning annonsörer efter behov.
...
I Publiker > Alla målgrupper och i avsnittet Målgrupper i placeringsinställningarna kan du filtrera varje segmentlista efter storleksintervall, inklusive separata intervall för specifika enhetstyper eller universella ID-typer.
...
* Den aktiva borttagna målgruppsstorleken för alla valda segment och sparade målgrupper visas, och du kan visa information per enhetstyp (webbläsare, mobil eller ansluten TV).

  ![den kombinerade målgruppsstorleken](/help/dsp/assets/audience-size.png)

* För enskilda segment visas den aktiva målgruppsstorleken och CPM (om tillämpligt) bredvid segmentnamnet.

  ![den enskilda segmentstorleken](/help/dsp/assets/audience-size-segment.png)

* Du kan visa mer information om ett enskilt segment eller en sparad publik, inklusive storleken per webbläsare, mobil, ansluten TV och partner för universella ID. För sparade målgrupper är den totala aktiva målgruppsstorleken den totala mängden borttagna dubbletter.
