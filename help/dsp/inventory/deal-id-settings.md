...
description: Se beskrivningar av inställningarna för manuellt angivna kontrakt-ID:n.
...
|---------|-----------|-------------|----------|----------|
| [Avtalsinformation] | [!UICONTROL Deal name] | Namnet som identifierar din [!UICONTROL Deal ID] i Advertising DSP. Ange ett namn eller välj **[!UICONTROL Auto-name]** om du vill låta DSP generera ett namn baserat på avtalsinformationen.<br><br>Exempel på ett automatiskt genererat namn: `[!DNL 24159708 - Deal ID - Guaranteed Fixed - USD - 5 - 24Kitchen - Private]` | Ja | Ja |
...
| | [Valuta] | Valutan för erbjudandet.<br><br>Alla SSP accepterar erbjudanden i USD. När SSP godkänner valutan för ditt DSP-konto är även den valutan tillgänglig. | Ja | Nej |
