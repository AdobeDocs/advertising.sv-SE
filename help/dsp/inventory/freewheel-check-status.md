...
1. (Valfritt) Filtrera data så att du kan hitta specifika avtal och annonser.
   ...
   För misslyckade överföringar visas felet i svarskolumnen [!UICONTROL API]. En fullständig lista över felkoder för misslyckade överföringar och nästa steg för att korrigera dem finns i &quot;[Felkoder för [!DNL FreeWheel] och skickade bidrag](freewheel-error-codes.md)&quot;.
