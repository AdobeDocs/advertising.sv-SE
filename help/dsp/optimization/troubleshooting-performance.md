...
| | Kontot har inte tillräckligt med finansiering. | Om du vill se om ditt konto är tillräckligt finansierat går du till **[!UICONTROL Settings]** > **[!UICONTROL Account]** och tittar på mängden [!UICONTROL Usable Funds]. Om du behöver lägga till mer pengar kontaktar du ditt Adobe-kontoteam. |
