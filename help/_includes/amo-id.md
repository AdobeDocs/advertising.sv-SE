...
Se [formaten för AMO ID-dimensionsobjekt](https://experienceleague.adobe.com/en/docs/analytics/components/dimensions/amo-id#dimension-items) i&quot;Adobe Analytics Components Guide&quot;.
