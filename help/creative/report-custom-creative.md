...
Du kan generera rapporter en gång eller schemalägga dem en gång om dagen, en gång om veckan eller en gång i månaden med 03:00 i den angivna tidszonen enligt angivna villkor (till exempel var 15:e dag eller den 1:e varje månad). När en rapport har skapats kan du hämta den från [!UICONTROL Reports] > [!UICONTROL Custom Reports] eller från länkade [rapportmål](/help/dsp/reports/report-destinations/report-destination-about.md) av följande typer:
...
| [!UICONTROL Dimension] | [!UICONTROL Ad] | [!UICONTROL Rotation Type] | Anger om annonser har roterats algoritmiskt (*Algoritmisk*), i en angiven sekvens (*Sekvensbaserad*) eller enligt relativa vikter (*Viktad*). |
