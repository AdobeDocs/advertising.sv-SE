...
# Vad är det för skillnad i [!DNL Creative] 2.0?
...
| | [!UICONTROL Creative Libraries] > [!UICONTROL Creatives] | Vyn [!UICONTROL Creatives] innehåller flikar för [!UICONTROL Standard Ads] och [!UICONTROL Dynamic Ads].<ul><lu>På fliken **[!UICONTROL Standard Ads]** kan du överföra och hantera bilder, HTML5, flexibla HTML5 och andra kreatörer.</li><li>På fliken **[!UICONTROL Dynamic Ads]** kan du hantera dynamiskt genererade annonser som har skapats från överförda feedsfiler med hjälp av definierade annonsmallar. Dynamisk annonsgenerering har tidigare gjorts i [!DNL Adobe Advertising Dynamic Creative Optimization (DCO)].<br><br> För närvarande kan du förhandsgranska, duplicera och ta bort dynamiska annonser och bifoga dynamiska annonser till kreativa paket för riktade annonsupplevelser eller till annonstaggar för upplevelser som inte är målinriktade. Endast administratörsanvändare kan skapa dynamiskt genererade annonser.</li></ul> | Se &quot;[Om dina kreativa bibliotek](/help/creative/creative-libraries/creative-libraries-about.md).&quot; |
...
| | [!UICONTROL Experiences] | I inställningarna för annonsupplevelsen anger du nu om upplevelsen ska använda beslutsträdsanpassning eller inte. Arbetsflödena för upplevelser med målgruppsanpassning i beslutsträd och upplevelser utan det är olika. | Se&quot;Arbetsflöde för upplevelser med målgruppsanpassning i beslutsträd&quot; och&quot;Arbetsflöde för upplevelser utan målinriktning i beslutsträd&quot;. |
